...
import social.gatewayservice.com.gatewayservice.dto.JwtParseRequestDto;
import social.gatewayservice.com.gatewayservice.dto.JwtParseResponseDto;
...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final String JWT_PARSE_URL = "http://auth-service/api/jwt/parse"; //test
    ...
    private JwtParseResponseDto parseJwt(String token) {
        JwtParseResponseDto responseDto = restTemplate.postForObject(JWT_PARSE_URL, JwtParseRequestDto.builder()
                        .token(token).build(),
